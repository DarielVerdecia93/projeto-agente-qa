...
- Apresentação do projeto: [`docs/apresentacao/apresentacao-agente-qa.pdf`](docs/apresentacao/apresentacao-agente-qa.pdf)
...
- [`docs/apresentacao/apresentacao-agente-qa.pdf`](docs/apresentacao/apresentacao-agente-qa.pdf)
  — apresentação de 2 slides do projeto (problema, agente, entrada/saída e fluxo geral),
  visualizável direto no GitHub. Fonte editável em
